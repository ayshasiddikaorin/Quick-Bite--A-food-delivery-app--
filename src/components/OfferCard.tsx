...
const OfferCard: React.FC<Props> = ({ item, fullWidth = false, onPress }) => {
  return (
    <TouchableOpacity
    ...
    >
      ...
      <View style={styles.content}>
        ...
        <View style={styles.orderBtn}>
          <Text style={styles.orderBtnText}>View Restaurant</Text>
...
const styles = StyleSheet.create({
  ...
  discountValue: { color: Colors.white, fontSize: 18, fontWeight: '900', lineHeight: 20 },
  discountLabel: { color: Colors.white, fontSize: 10, fontWeight: '700', letterSpacing: 1 },
  validTag: {
  ...
  validText: { color: Colors.white, fontSize: 10, fontWeight: '600' },
  content: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 16 },
  title: { color: Colors.white, fontSize: 18, fontWeight: '800', marginBottom: 3 },
  description: { color: 'rgba(255,255,255,0.85)', fontSize: 12, fontWeight: '500', marginBottom: 10 },
  orderBtn: {
    flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start',
    backgroundColor: Colors.white,
    paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, gap: 6,
  },
  orderBtnText: { color: Colors.primary, fontSize: 12, fontWeight: '700' },
});
